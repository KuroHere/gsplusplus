...
public class Shader {
    ...
    public Shader(String fragmentShader) {
        ...
        int vertexShaderID;
        try {
            InputStream vertexStream = this.getClass().getResourceAsStream("/assets/gamesense/shaders/vertex.vert");
            ...
            InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/gamesense/shaders/fragment/" + fragmentShader);
